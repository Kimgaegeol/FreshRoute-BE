...
// 주문 삽입 SQL (state 고정, is_finished FALSE)
const insertOrderSql = `
  INSERT INTO orders.list
    (account_idx, production_idx, state, is_finished)
  VALUES
    ($1, $2, $3, FALSE)
...
/* POST /orders
   Body (JSON):
     {
       "production_idx": [3, 7, 12]   // 또는 단일 값 5
     }
   → state: "배송 준비 중", is_finished: false
*/
